     ...
     $('.slideshow_box').each(function () {
        ...
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
            ...
            var $container = $(this),                                 // a
                $slideGroup = $container.find('.slideshow'),   // b
        ...
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
            ...
            $slides.each(function (i) {
                $(this).css({ left: 100 * i + '%' });
                indicatorHTML += '<li><a href="#">' + (i + 1) + '</a></li>';
            });
        ...
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
            ...
            $indicator.on('click', 'li', function (event) {
                event.preventDefault();
            ...
            // 마우스오버면 타이머를 정지 그렇지 않으면 시작-없애면 자동정지
            $container.on({
